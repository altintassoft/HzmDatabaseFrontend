  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Endpoint Uyum Analizi</h3>
          <p className="text-sm text-gray-600">SMART_ENDPOINT_STRATEGY_V2 ile Backend Karşılaştırması</p>
        </div>
        <button
