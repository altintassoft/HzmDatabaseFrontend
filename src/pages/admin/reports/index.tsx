...
import { ArrowLeft, Database, Activity, GitCompare, Settings, FolderTree, Zap } from 'lucide-react';
...
type TabType = 'tables' | 'migration-schema' | 'architecture' | 'configuration' | 'project-structure' | 'api-endpoints';
...
const BackendReportsPage = () => {
  ...
  // 🔒 ROLE-BASED TAB VISIBILITY: Migration/Schema, Architecture, Configuration, Project Structure, API Endpoints tab'ları sadece admin ve master_admin için
  ...
  const showApiEndpointsTab = ['admin', 'master_admin'].includes(userRole);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
          <div className="flex border-b border-gray-200">
            ...
            {/* API Endpoints - Sadece admin ve master_admin */}
            {showApiEndpointsTab && (
              <button
          ...
          <div className="p-6">
            ...
            {/* API Endpoints Tab */}
            {showApiEndpointsTab && (
              <div className={activeTab === 'api-endpoints' ? 'block' : 'hidden'}>
                <ApiEndpointsTab />
              </div>
            )}
          </div>
